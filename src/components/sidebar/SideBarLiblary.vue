...
<template>
    <div class="flex flex-col">
        ...
        <div class="flex flex-col gap-y-2 mt-4 px-3">
            <button @click="handleCreatePlaylist" class="flex items-center justify-start w-full rounded-full bg-neutral-900 py-1 py-1text-neutral-400 
            hover:bg-neutral-800 text-neutral-400 gap-x-2 hover:text-white transition"
            >
                <AiOutlinePlus
