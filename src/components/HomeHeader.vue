    ...
    <div :class="twMerge(`h-fit bg-gradient-to-b from-emerald-800 p-6`)">
        <div class="w-full mb-4 flex items-center justify-between">
            ...
            <div class="flex md:hidden gap-x-2 items-center">
                <button class="rounded-full p-2 bg-white flex items-center justify-center hover:opacity-75 transition">
            ...
            <div class="flex justify-between items-center gap-x-4">
                <div>
                    <LoginButton class="bg-transparent text-neutral-300 font-medium">
                        Sign up    
                    </LoginButton>
                </div>
                <div>
                    <LoginButton class="bg-white px-6 py-2">
                        Log in    
                    </LoginButton>
                </div>
            </div>
