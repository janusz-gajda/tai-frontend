    ...
    <div class="bg-neutral-900 rounded-lg h-full w-full overflow-hidden overflow-y-auto">
        ...
        <div v-if="userStore.id" class="flex flex-col items-center w-full">
            ...
            <main class="mt-2 px-6 w-full max-w-[800px] flex flex-col md:flex-row justify-around">
                <div
                    class="flex flex-col justify-center items-center w-full md:w-1/2 md:max-w-[400px] mr-10"
                >
                    ...
                    <button
                        ...
                        class="w-full max-w-[200px] rounded-full hover:bg-green-500 bg-green-700 px-4 py-3 mt-10 text-white font-bold transform"
                    >
                        Change info
                    </button>
                </div>
                <div
                    class="flex flex-col justify-center items-center w-full md:w-1/2 md:max-w-[400px]"
                >
